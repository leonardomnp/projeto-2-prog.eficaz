...
def test_listar_imoveis(mock_listar_imoveis, client):
...
@patch("routes.listar_imoveis")
def test_listar_imoveis_vazio(mock_listar_imoveis, client):
...
@patch("routes.listar_imoveis")
def test_listar_imoveis_erro(mock_listar_imoveis, client):
